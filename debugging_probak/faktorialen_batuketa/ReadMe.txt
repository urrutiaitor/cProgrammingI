========================================================================
    APLICACIÓN DE CONSOLA: faktorialen_batuketa Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación faktorialen_batuketa.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación faktorialen_batuketa.


faktorialen_batuketa.vcxproj
...
faktorialen_batuketa.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado faktorialen_batuketa.pch y un archivo de tipos precompilados llamado StdAfx.obj.
