========================================================================
    APLICACIÓN DE CONSOLA: faktoriala_funtzioekin Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación faktoriala_funtzioekin.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación faktoriala_funtzioekin.


faktoriala_funtzioekin.vcxproj
...
faktoriala_funtzioekin.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado faktoriala_funtzioekin.pch y un archivo de tipos precompilados llamado StdAfx.obj.
